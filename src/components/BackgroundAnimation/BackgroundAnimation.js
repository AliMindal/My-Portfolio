...
const BackgroundAnimation = () => {
  ...
  return (
    ...
    >
      <svg
        ref={svgRef}
        className="absolute w-[600px] h-[600px] max-w-full transition-transform duration-300 ease-out"
        style={{
      ...
      >
        ...
        {/* Orbiting Elements */}
        <circle r="1.1" fill="#945DD6">
          <animateMotion dur="10s" repeatCount="indefinite" rotate="auto">
            <mpath href="#path_2" />
          </animateMotion>
        </circle>

        <circle r="1.1" fill="#46737">
        ...
        {/* Gradients */}
        <defs>
          <radialGradient id="paint0_radial" cx="0.5" cy="0.5" r="0.5">
            <stop offset="0%" stopColor="#945DD6" />
            <stop offset="100%" stopColor="#945DD6" stopOpacity="0" />
          </radialGradient>
          <radialGradient id="paint1_radial" cx="0.5" cy="0.5" r="0.5">
