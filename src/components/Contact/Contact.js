  ...
  return (
    <div className="section-container mt-36" id="contact">
      ...
      <div className="flex justify-center items-center w-full">
        <form
          className="w-2/3"
          action="https://public.herotofu.com/v1/c3ed4490-33d6-11f0-9fa6-fb36ca6da6ff"
          method="POST"
        >
          <div className="grid md:grid-cols-2 md:gap-6">
            <div className="relative z-0 w-full mb-6 group">
              <input
                ...
                className="block py-2.5 px-0 w-full text-sm text-white-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-purple-600 focus:outline-none focus:ring-0 focus:border-purple-600 peer"
                placeholder=" "
                required
              />
              <label
